...
if(isset($_POST['Submit'])) 
{
    ...
    else
    {
        ...
        if($count[0]>=2)//If user forgets password too frequently in a row,
...
<html lang="en">
  <head>
    ...
    <!-- ^ the two above are for index.php, signup.php, forgot_password.php -->
    <!-- incorrect, those 4 themes are for the dashboard, not index.php -->
