										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control border-input" value="" disabled placeholder>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea rows=4 type="text" class="form-control border-input" disabled placeholder>    </textarea>
												</div>
											</div>
										</div>
									</form>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$.notify({
			icon: 'ti-gift',
			message: "Welcome to the <b>Get Reports Page</b> - Choose an event from the button to display it's information."
