            ...
            if(isset($_POST['btn-edit'])||isset($_POST['btn-change']))
            {
                ...
                while ($row = $page->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo        "</select> </td>
                                ...
                                <td><label for='expiry'>
                                <input type='date' class='datepicker' name='expiry[$index][$id]' value='$date' min='" . date('Y-m-d') . "' required>
                                </label></td>
                ...
                if(!isset($_POST['btn-change'])) {
                    echo "<br><div class=\"click\">
                            <button type=\"submit\" name=\"btn-change\" class=\"btn btn-info btn-fill btn-wd\">Update User(s)
                            </button>
                        </div></form>";
                }
            }
